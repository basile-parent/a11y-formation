...
2. créer une entrée dans l'objet `config` du fichier [AccesSlide.js](js/AccesSlide.js) (voir l'exemple dans le fichier) ;
...
Les éléments de l'interface peuvent être traduits dans un fichier de langue (dossier [lang](js/lang/)).
